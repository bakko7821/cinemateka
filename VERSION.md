...
- На нескольких страницах решена проблема с отображением звезд, из-за конфликта с удаленными иконками.
- На страницу **ReviewCard.tsx** добавленна возможность открыть страницу фильма на Кинопоиске.

## commit 14.26.5

- Изменен блок поиска на странице добавления фильма
...
- Создана страница **pages/NotFoundPage.tsx** - при попадании на несуществующую страницу.
- Переписанны стили. Все font-size перенесенны в переменные.
- На всех страницах теперь код обернут в div > page.
- Переписан **App.tsx**, теперь на страницах **LoginPage.tsx**, **RegisterPage.tsx** и всех пустых страницах - не отображается **Header.tsx**

## commit 15.35.6

### Серверная часть

- В **/routes/users.ts** - Добавлен GET роут на получение всех пользователей
- В **/routes/films.ts** - Добавлен GET роут на получение данных о фильме по его ID

### Клиентская часть

- Создан компонент **/components/HomePage/RandomRecomendedReviews.tsx**
- Для компонента добавленны стили в **/styles/Home.css**
